...
def get_embeddings(
    ...
    if embeddings is None:
        ...
        for img in imgs:  # type: ignore
            embeds = embedding_func(img) # list of embeddings
    ...
    embeddings = convert_shape(embeddings).tolist()  # embeddings
...
fthresholds = {
    ...
    "chromadb": {
        "cosine_l2": {"operator": "le", "direction": "positive", "value": 0.6},
        "ip_l2": {"operator": "ge", "direction": "negative", "value": 1.},
        "l2_l2": {"operator": "le", "direction": "positive", "value": 500},
        #  "cosine_l2": {"operator": "ge", "direction": "positive", "value": 0.4},
        #  "ip_l2": {"operator": "ge", "direction": "positive", "value": 0.3},
        # "l2_l2": {"operator": "le", "direction": "negative", "value": 1.0}
